      ...
      <div className="w-full max-w-md">
        <div className="bg-white border border-gray-200 p-8 rounded-3xl shadow-xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-2 text-sm">Start your journey today</p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div>
              <label className="text-gray-700 text-xs font-semibold block mb-1.5">Confirm Password</label>
          ...
          <p className="text-center mt-6 text-gray-600 text-sm">
            ...
            <button onClick={() => navigate('/login')} className="text-[#6366F1] hover:text-[#4F46E5] font-semibold">Login</button>
          </p>
